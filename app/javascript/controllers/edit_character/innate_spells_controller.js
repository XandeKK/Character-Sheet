  ...
  const body = [
    ...
    `<div class="flex">`,
      `<div class="flex-1">`,
        ...
        `<input class="rounded-none rounded-l-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-transparent dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="number" name="character[pathfinder_innate_spells_attributes][${value}][frequency]" id="character_pathfinder_innate_spells_attributes_${value}_frequency">`,
      `</div>`,
      `<div class="flex-1">`,
