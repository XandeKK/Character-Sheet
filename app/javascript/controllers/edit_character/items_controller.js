...
function appendItemInForm(value) {
  const body = [
    `<div class="flex">`,
      ...
      `</div>`,
      `<div>`,
        `<label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="character_pathfinder_items_attributes_${value}_weight">Weight</label>`,
        `<input class="rounded-none bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-transparent dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="number" name="character[pathfinder_items_attributes][${value}][weight]" id="character_pathfinder_items_attributes_${value}_weight">`,
      `</div>`,
      `<div>`,
