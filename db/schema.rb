...
ActiveRecord::Schema[7.0].define(version: 2022_09_24_105530) do
  ...
  create_table "adventure_participations", force: :cascade do |t|
    t.bigint "character_id", null: false
    t.bigint "adventure_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["adventure_id"], name: "index_adventure_participations_on_adventure_id"
    t.index ["character_id"], name: "index_adventure_participations_on_character_id"
  end
  ...
  create_table "pathfinder_melees", force: :cascade do |t|
    ...
    t.integer "multiple_attack_penalty_2"
    t.integer "multiple_attack_penalty_3"
    t.string "die"
    t.integer "item"
    t.string "other"
    t.text "notes"
  ...
  add_foreign_key "adventure_participations", "adventures"
  add_foreign_key "adventure_participations", "characters"
